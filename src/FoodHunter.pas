...
type
	...
	FoodHunterData = record
		...
		food: array [0..4] of FoodData; // There is an array of food
...
begin
	...
	else if y > ScreenHeight() then //offscreen base
	begin
		y := -BitmapHeight(bmp);
	end;
end;
...
procedure UpdateHunter(var hunter: HunterData);
begin
	WrapCharacter(hunter.bmp, hunter.x, hunter.y);
end;
